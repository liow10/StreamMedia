...
//
//public class RtspToRtspHandler extends SimpleChannelInboundHandler<FullHttpRequest>
//{
...
//                            playH264(new PipedOutputStream());
...
//    public void playH264(PipedOutputStream outputStream){
...
//    public void playH265(byte[] buffer){
////    	int time = rtpTimestamp;
//        int time = 0;
//        //播放h265视频文件
////        BufferedInputStream in = null;
...
////            in = new BufferedInputStream(pis);
//            int buf_size = 64*1024;
//          //  byte[] buffer = System.arraycopy();		//从文件读的字节存入的地方
//            byte[] nalu;							//临时存储一个nalu单元内容
//            byte[] firstHalfNalu = null;			//nalu前半段
//            byte[] secondHalfNalu = null;			//nalu后半段
//            int len = 0;							//每次从文件读的字节数
