...
//import static com.micro.iotclouds.modules.hls.ts.TransportStreamUtils.fillPAT;
//import static com.micro.iotclouds.modules.hls.ts.TransportStreamUtils.fillPMT;
//
//import java.io.File;
...
//	        i6 = j != 0 ? 10 : 5;
//	        i7 = i + i6 + 3;
//	        BufferUtil.intToByteArray(i7, this.block, i3, 2);
//	        i3 += 2;
//	        this.block[i3] = -128;
//	        i3++;
...
//	            }
//	        } else if (codec == 7) {
//	        	int cts = BufferUtil.byteArrayToInt(dataBytes, 2, 3) * 90;
//	            long ts = ts90 + cts;
//	            int i4 = 1;
//	            int loop = 5;
//	            int naluLen;
...
//	                             l5 = pcr;
//	                             l5 <<= 7;
//	                             byte[] arrayOfByte6 = BufferUtil.longToByteArray(l5);
...
//	                           BufferUtil.intToByteArray(i30, this.block, tsIdx, 2);
//	                           tsIdx += 2;
