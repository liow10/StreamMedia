//package com.micro.iotclouds.modules.rtmp.util;
//
...
//
//					redisAddr = StringUtils.isNotEmpty(MyLiveConfig.getInstance().getRedisAddr())?MyLiveConfig.getInstance().getRedisAddr():"127.0.0.1";
