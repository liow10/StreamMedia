...
//
//@Slf4j
//public class RtspHandler2 /* extends HttpFlvHandler */ extends SimpleChannelInboundHandler<FullHttpRequest>
...
//
//	public RtspHandler2(StreamManager streamManager) {
...
//			RtspRequestHelper.getInstance().httpResponseStreamNotExist(ctx, uri);
//			CloseThisClient();
//			return;
//		}
//
