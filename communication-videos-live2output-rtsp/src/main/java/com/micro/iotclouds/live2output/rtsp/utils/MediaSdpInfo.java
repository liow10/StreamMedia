...
public class MediaSdpInfo {
	...
	public MediaSdpInfo(String media, String codec, int rtpPayloadType, int clockRate, String control) {
		super();
		this.media = media;
		this.codec = codec;
	...
	public String toString() {
		return "MediaSdpInfo [media=" + media + ", codec=" + codec + ", rtpPayloadType=" + rtpPayloadType
				+ ", clockRate=" + clockRate + ", control=" + control + "]";
	}
