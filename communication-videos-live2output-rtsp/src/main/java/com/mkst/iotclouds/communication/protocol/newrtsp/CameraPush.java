...
//
//	/*
//	 * // 配置类 private static Config config;
//	 * 
//	 * // 通过applicationContext上下文获取Config类 public static void
//	 * setApplicationContext(ApplicationContext applicationContext) { config =
...
//		// 采集/抓取器
//		grabber = new FFmpegFrameGrabber("rtsp://admin:hik12345@192.168.1.4:554/h264/ch1/main/av_stream");
//
...
//		try {
//			rtspSocket.connect(new InetSocketAddress("192.168.1.4", 554), 1000);
//		} catch (IOException e) {
//			grabber.stop();
//			grabber.close();
//			rtspSocket.close();
...
//		}
//		try {
//			rtmpSocket.connect(new InetSocketAddress("127.0.0.1", Integer.parseInt("554")), 1000);
//		} catch (IOException e) {
//			grabber.stop();
//			grabber.close();
//			rtspSocket.close();
//			// logger.error("与推流IP： " + config.getPush_host() + " 端口： " +
//			// config.getPush_port() + " 建立TCP连接失败！");
//			return null;
//		}
//
