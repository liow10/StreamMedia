...
//
//import com.mkst.iotclouds.communication.protocol.newrtsp.NewRtspServer;
//import com.mkst.iotclouds.communication.protocol.newrtsp.streamhub.StreamFrame;
//import com.mkst.iotclouds.communication.protocol.newrtsp.streamhub.StreamHub;
//
...
//
//public class NewRtspHandler extends HttpFlvHandler {
...
//
//				rtpchn = NewRtspServer.createUdp(((InetSocketAddress) ctx.channel().localAddress()).getHostString(),
//						localrtpport);
//				rtcpchn = NewRtspServer.createUdp(((InetSocketAddress) ctx.channel().localAddress()).getHostString(),
//						localrtpport + 1);
//				localrtpport += 2;
//
//			} else {
...
//			 * System.out.println("ANNOUNCE"); // CloseThisClient(); // return; //
//			 * HttpRequest request = null; // request = new
//			 * DefaultHttpRequest(RtspVersions.RTSP_1_0, RtspMethods.ANNOUNCE, //
//			 * r.getUri()); //r.headers().set(Names.CSEQ, r.headers().get(Names.CSEQ));
//			 * //r.headers().set(RtspHeaders.Names.DATE, DateUtil.getGmtDate());
//			 * //r.headers().set(RtspHeaders.Names.SESSION,
//			 * o.headers().get(RtspHeaderNames.SESSION)); r.headers().set("Notice",
//			 * "1103 \"Stream Stalled\" event-date=20000406T091645Z"); // return request; }
//			 */else {
